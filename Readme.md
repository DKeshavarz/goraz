# Goraz
Learn web as **fast** as you can.

<img src="./Assets/goraz.jpg" alt="Goraz icon"  style="display: block; margin-left: auto; margin-right: auto; width: 50%;" >


## Topics
- [Module 1: Foundations](./01/readMe.md)
